...
addi $sp , $sp , -4
# Storing Frame Pointer and Return Address Before Calling the object's method : changeX
addi $sp , $sp , -12
sw $fp , 4($sp)
sw $ra , 8($sp)
sw $s5 , 12($sp)
...
addi $sp , $sp , -4
jal __ali_changeX # Calling Object's method
...
sw $t0 , 0($sp) # Storing Function Address in Stack 
addi $sp , $sp , -4
# Storing Frame Pointer and Return Address Before Calling the object's method : getX
addi $sp , $sp , -12
sw $fp , 4($sp)
sw $ra , 8($sp)
sw $s5 , 12($sp)
...
addi $sp , $sp , -4
jal __ali_getX # Calling Object's method
